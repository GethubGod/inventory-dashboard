/**
 * Marketing-specific animation utilities.
 *
 * This module was moved from src/lib/motion.ts since it's only used
 * by marketing page components. Dashboard and app components should
 * import framer-motion directly if needed.
 */
