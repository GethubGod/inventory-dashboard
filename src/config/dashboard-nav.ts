 ...
 *
 * Static nav config for the dashboard sidebar and breadcrumbs.
 * Component implementations that consume this config remain in
...
export type DashboardNavItem = {
  ...
  href: string;
  icon: LucideIcon;
  /** Mark as placeholder — shows "coming soon" styling */
  placeholder?: boolean;
};
...
export const DASHBOARD_NAV_GROUPS: DashboardNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Locations", href: "/dashboard/locations", icon: MapPin, placeholder: true },
      { label: "Quick Order", href: "/dashboard/quick-order", icon: Zap, placeholder: true },
      {
        label: "Import / Export",
  ...
  },
  {
    ...
    icon: ChefHat,
    items: [
      { label: "Recipes", href: "/dashboard/recipes", icon: ChefHat, placeholder: true },
      { label: "Forecasts", href: "/dashboard/forecasts", icon: TrendingUp, placeholder: true },
    ],
  },
  {
    id: "integrations",
    ...
    icon: CreditCard,
    items: [
      { label: "Square POS", href: "/dashboard/square", icon: CreditCard, placeholder: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Accuracy", href: "/dashboard/accuracy", icon: Crosshair, placeholder: true },
    ],
  },
  {
    id: "settings",
